...
DELETE FROM `taxi_nodes` WHERE `ID` IN (45, 72, 73, 602, 603, 604);
...
(603, 'Sunveil Excursion, Blasted Lands', -12357.6, -3058.23, 90.3242, 19917, 0, 0, 0, 0, 0, 0, 0, 0, 111, 2, 0, 0),
(604, 'Dreadmaul Hold, Blasted Lands', -10933.3, -2790.98, 25.6968, 2224, 0, -0.01, 0.015, 0, 0, 0, 0, 0, 112, 2, 0, 0);

-- Reference for 'TableHash': https://github.com/TrinityCore/WowPacketParser/blob/master/WowPacketParser/Enums/DB2Hash.cs
DELETE FROM `hotfix_data` WHERE `Id` IN (45, 72, 73, 602, 603, 604);
INSERT INTO `hotfix_data` (`Id`, `TableHash`, `RecordID`, `Timestamp`, `Deleted`) VALUES
(45, 1356405368, 45, 0, 0),
(72, 1356405368, 72, 0, 0),
(73, 1356405368, 73, 0, 0),
(602, 1356405368, 602, 0, 0),
(603, 1356405368, 603, 0, 0),
(604, 1356405368, 604, 0, 0);